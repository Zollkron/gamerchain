@echo off
REM Script seguro para iniciar Nodo 2 - Verifica puerto antes de iniciar
REM IP: Variable de entorno

echo ============================================================
echo 🚀 INICIANDO NODO 2 TESTNET PLAYERGOLD (SEGURO)
echo ============================================================
echo.
...
echo.
echo 💡 Para reiniciar:
echo    scripts\start_node2_testnet_seguro.bat
echo.
