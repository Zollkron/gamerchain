...
class BlockchainNodeService {
  constructor() {
    ...
    this.port = 18081; // Default testnet port (second instance)
    this.apiPort = 19081; // API port (second instance)
   ...
   */
  async findAvailablePort(startPort = 18081) {
  ...
  async startNode(options = {}) {
    ...
    try {
      ...
      // Find available port
      this.port = await this.findAvailablePort(18081);
